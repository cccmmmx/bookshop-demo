...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="background: #f5f5f5;">
        ...
        <div style="padding: 15px;" class="layui-col-xs5">
            <form  class="form-inline" role="form" action="/category/index">
                <div class="layui-inline">
                    <input type="text" class="layui-input" name="text" id="text"  placeholder="分类名">
                </div>
                <div class="layui-inline">
                    ...
                    <#--<input type="text" class="layui-input" name="parent" id="parent" placeholder="所属父类">-->
                </div>
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <tbody>
                        ...
                        <td>
                            ...
                            <td>
                                <a href="/category/update/${c.id!''}" title="编辑">
        ...
        <div class="layui-col-xs12">
            ...
            <#if pageinfo.hasPreviousPage>
                <li><a href="/category/index?page=${pageinfo.prePage}">上一页</a></li>
            </#if>
            <#list pageinfo.navigatepageNums as p>
                <li class="<#if "${p}"="${pageinfo.pageNum}">active</#if>"><a href="/category/index?page=${p}">${p}</a></li>
            </#list>
            <#if pageinfo.hasNextPage>
                <li><a href="/category/index?page=${pageinfo.nextPage}">下一页</a></li>
            </#if>
        </ul>
        </div>
        <div style="margin-left: 20px" class="layui-col-xs7">
            <div class="alert alert-info" role="alert">分类管理操作注意类别下是否已经有所属商品</div>
        </div>
                            ...
                            $.ajax({
                                ...
                                success : function(data) {
                                    if (data==true){
                                        ...
                                        layer.open({
                                            title: '提示'
                                            ,content: '删除失败，所选的类别中有对应的商品，不能删除'
                                            ,area: ['400px','200px']
                                            ,btn: ['确定']
                                            ,yes: function(index, layero){
                                                // $("#code_input").val("").focus();
