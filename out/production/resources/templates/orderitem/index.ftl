    ...
    <div class="layui-body" style="background: #f5f5f5;">
        ...
        <div class="layui-row">
            ...
            <div style="padding: 15px;" class="layui-col-xs5">
                <form  class="form-inline" role="form" action="/orderitem/index">
        ...
        <table class="layui-table" lay-skin="line">
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <#--<td>-->
                                <#--<a href="/orderitem/update/${c.id!''}" title="查看">-->
                                    <#--<button type="button" class="layui-btn"><i class="fa fa-eye" aria-hidden="true"></i> 查看</button>-->
                                <#--</a>-->
                            <#--</td>-->
                        </tr>
                        </#list>
